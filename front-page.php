...
<section class="content section-line1" id="content">
    <div class="content__inner">
      ...
      <div class="content__header section-header inner">
        ...
        <p class="section-header__subtitle -left">content</p>
      </div><!-- ./section-header -->
  ...
  <section class="works">
    <div class="works__inner">
      ...
      <div class="works__header section-header inner">
        ...
        <p class="section-header__subtitle -right">works</p>
      </div><!-- ./section-header -->
  ...
  <section class="overview section-line2">
    <div class="overview__inner">
      ...
      <div class="overview__header section-header inner">
        ...
        <p class="section-header__subtitle -left">overview</p>
      </div><!-- ./section-header -->
  ...
  <section class="blog">
    <div class="blog__inner inner">
      ...
      <div class="blog__header section-header">
        ...
        <p class="section-header__subtitle -right">blog</p>
      </div><!-- ./section-header -->
      <!-- blog-card-list -->
