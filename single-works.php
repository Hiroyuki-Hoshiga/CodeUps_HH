  ...
  <body>
    ...
    <main class="page-overview">
      ...
      <div class="page-overview__inner inner">
        ...
        <h1 class="post-header__title"><?php the_title( '<h1 class="title default-max-width">', '</h1>' ); ?></h1>
        <div class="post-header__meta">
          <time datetime="<?php the_time( "Y.m.d" ); ?>"><?php the_time( "Y.m.d" ); ?></time>
          <span class="tag"><?php $terms = wp_get_object_terms($post->ID,'works_cate'); foreach($terms as $term){echo $term->name . '';} ?></span>
        </div>
      </div><!-- ./post-header -->
